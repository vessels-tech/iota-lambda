  ...
  attachToTangle: function(trunkTransaction, branchTransaction, minWeightMagnitude, trytes, callback)
  {
    ...
    if (this.libccurl !== null)
    {
      ...
      let getBundleTrytes = function (thisTrytes, callback)
      {
        ...
        if (!previousTxHash)
        {
          console.log('lastIndex:', txObject.lastIndex);
          console.log('currentIndex:', txObject.currentIndex);

          // Check if last transaction in the bundle
          // console.warn("WE DISABLED THE BUNDLE ORDER CHECK. I DON'T UNDERSTAND WHY IT EXISTS.");
